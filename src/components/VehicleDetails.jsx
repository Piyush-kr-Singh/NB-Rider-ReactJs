...
const VehicleDetails = () => {
  ...
  useEffect(() => {
    ...
    axios.get('/data.json').then((response) => {
      const vehicleDetails = response.data.vehicles[0].details;
  ...
  if (!selectedDetail) {
    return <div className="d-flex justify-content-center"></div>; // Display a loading message while data is being fetched
  }
